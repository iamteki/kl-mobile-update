...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('frontend/assets/images/kl_logo_final_original.svg') }}" alt="KL Mobile Events"
                    class="footer-logo">
                <p class="text-white-50">Your trusted partner for corporate event management, fabrication, sound,
                    lighting, LED screens and full event production in Kuala Lumpur.
                </p>
            </div>
                ...
                <div class="social-links d-flex flex-wrap justify-content-md-end justify-content-center gap-2">
                    @if (isset($settings) && $settings->hasSocialMediaLinks())
                        ...
                        @foreach ($settings->formattedSocialLinks as $platform => $social)
                            <a href="{{ $social['url'] }}" class="social-icon-small" aria-label="{{ $social['label'] }}"
                    ...
                    @else
                        ...
                        <a href="https://www.facebook.com/share/1GFC7f5z4s/?mibextid=wwXIfr" class="social-icon-small"
                            aria-label="Facebook" target="_blank" rel="noopener noreferrer" title="Facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://www.instagram.com/" class="social-icon-small" aria-label="Instagram"
                            target="_blank" rel="noopener noreferrer" title="Instagram">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="http://tiktok.com" class="social-icon-small" aria-label="TikTok" target="_blank"
                            rel="noopener noreferrer" title="TikTok">
                            <i class="fab fa-tiktok"></i>
                        </a>
                        <a href="http://linkedin.com" class="social-icon-small" aria-label="LinkedIn" target="_blank"
        ...
        <div class="text-center">
            <p class="mb-0 text-white-50">
                ...
                Developed by <b><a href="http://platformdaddy.com" target="_blank" class="text-white-50 text-decoration-none">Platform Daddy</a>.</b>
            </p>
...
<style>
    ...
    @media (max-width: 768px) {
        .social-icon-small {
            ...
            font-size: 13px;
            border-radius: 5px;
            /* Slightly smaller radius for smaller icons */
        }
    ...
    @media (max-width: 480px) {
        .social-icon-small {
            ...
            font-size: 12px;
            border-radius: 4px;
            /* Even smaller radius for mobile */
        }
