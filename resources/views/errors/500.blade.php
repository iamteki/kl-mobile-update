...
@section('title', 'Server Error - KL Mobile Events')
@section('meta_description', 'We\'re experiencing technical difficulties. Our team has been notified and we\'re working to fix the issue.')
@push('styles')
<style>
    .error-page-section {
        min-height: 100vh;
