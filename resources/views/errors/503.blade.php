...
@section('title', 'Maintenance Mode - KL Mobile Events')
@section('meta_description', 'We\'re currently down for maintenance. We\'ll be back shortly with an improved experience.')
    ...
    <div class="container">
        <div class="error-container">
            ...
            <p class="error-subtitle">
                We're currently down for scheduled maintenance. We'll be back shortly
                with an improved experience. Thank you for your patience.
            </p>
            
            <!-- Countdown Timer -->
            <div id="maintenance-countdown" style="color: var(--secondary-purple); font-size: 1.2rem; margin: 2rem 0;"></div>
...
<script>
    ...
    function updateCountdown() {
        ...
        target.setHours(now.getHours() + 2); // 2 hours from now
        ...
        document.getElementById('maintenance-countdown').innerHTML = 
            `Estimated time remaining: ${hours}h ${minutes}m ${seconds}s`;
        
        if (diff <= 0) {
            clearInterval(countdown);
            document.getElementById('maintenance-countdown').innerHTML = 
                "We're almost done! Refresh the page to check if we're back online.";
        }
    }
    ...
    // Same fade-in animation as other error pages
