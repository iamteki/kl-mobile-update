...
@section('title', 'Access Denied - KL Mobile Events')
@section('meta_description', 'You don\'t have permission to access this page. Please contact us if you believe this is an error.')
@push('styles')
<style>
    .error-page-section {
        min-height: 100vh;
